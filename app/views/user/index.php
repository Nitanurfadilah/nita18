    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">nitaaaa</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/nita2/app/"> <i class="bi bi-app-indicator"></i>
              </a>
            </li>
          </ul>
        </div>
         ...
         <?php foreach($data['project'] as $pro) : ?>
           <div class="col-sm-4 mb-4">
            <div class="card" style="width: 18rem;">
              <img src="<?= baseurl;?>/assets/img/<?= $pro['Foto']; ?>" class="card-img-top" alt="foto">
             <div class="card-body">
                <h3><?= $pro['Nama_p']; ?></h3>
      ...
      <footer class="row text-center bg-dark">
        <p class="text-white">created with <i class="bi bi-instagram"></i></i></i></i>Nanda Diana</p>
      </footer>
